    ...
    <section style={{ display: "grid", gap: 16 }}>
      ...
      >
        ...
        >
          ...
          <Form.Item name="taxRate" label="Tax Rate %" initialValue={11}>
            <InputNumber min={0} max={100} step={0.01} style={{ width: "100%" }} />
          </Form.Item>
          <Form.Item name="taxBehavior" label="Tax Behavior" initialValue="exclusive">
            <Select
              options={[
          ...
          <Form.Item name="isDefault" label="Default" valuePropName="checked" initialValue={false}>
            <Switch />
          </Form.Item>
