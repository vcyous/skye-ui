...
export default function LoginPage() {
  ...
  async function onSubmit(values: any) {
    ...
    try {
      ...
      setSubmitError((err as Error).message || "Login failed. Please try again.");
    } finally {
      setIsSubmitting(false);
    }
  }

  async function onResetSubmit(values: any) {
    setResetNotice("");
    ...
    try {
      ...
      setResetNotice((err as Error).message || "Unable to send reset email.");
    } finally {
